...
iotc_year   <- readRDS("data/processed/iotc/iotc_year_1deg_purseseine_flag.rds")
...
saveRDS(tuna_all_year,"data/processed/01_bound/allrfmo_year_1deg_purseseine_flag.rds")

...
# 5 degree level with flag data to a yearly resolution.
#
################################################################################
...
ll_month <- readRDS("data/processed/iotc/iotc_month_5deg_longline_flag.rds")
...
saveRDS(ll_year, "data/processed/iotc/iotc_year_5deg_longline_flag.rds")

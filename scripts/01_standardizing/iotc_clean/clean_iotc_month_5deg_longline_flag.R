...
# IOTC at the month, 5 degree level with flag data.
#
...
iotc_month_5deg_longline_flag_clean <- longline_prepped |>
  mutate(
...
saveRDS(
  iotc_month_5deg_longline_flag_clean,
  "data/processed/iotc/iotc_month_5deg_longline_flag.rds"
)
